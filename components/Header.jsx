...
import logoUrl from '../renderer/logo.jpeg'
import SearchBar from './SearchBar';
import { Link } from '../renderer/Link'
import { useAuth0 } from "@auth0/auth0-react";

export const Header = ({pageContext}) => {
  ...
  }, [pageContext?.data?.places]);

  return (
    <header
      className={`fixed top-0 z-10 flex w-screen justify-center bg-pink py-4 ${
        hasShadow ? 'shadow-md' : ''
      }`}
    >
      <div
